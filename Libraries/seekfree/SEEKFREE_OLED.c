...
void Variate_Display(unsigned short x, unsigned char y,float f)
{
	...
	if(f - (int)f == 0)
	{
		...
		a[0]='0'+in%100000/10000;
		a[1]='0'+in%10000/1000;
		a[2]='0'+in%1000/100;
		a[3]='0'+in%100/10;
		a[4]='0'+in%10/1;//加/1会好看很多，不准删它
		for(c=0;c<4;c++)
		{
			if(a[c]=='0')
				j++;
	...
	else
	{
		...
		a[0]=i%1000000/100000+0x30;
		a[1]=i%100000/10000+0x30;
		a[2]=i%10000/1000+0x30;
		a[3]='.';
		a[4]=i%1000/100+0x30;
		a[5]=i%100/10+0x30;
		a[6]=i%10/1+0x30;//加/1会好看很多，不准删它
		if(a[0]==0x30)
		{
			j++;
			if(a[1]==0x30)
